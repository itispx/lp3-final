	...
	public UIDificuldade() {
		...
		btnJogar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// TO DO: Conferir se dificuldade foi selecionada
				// TO DO: Ir para a tela do jogo
			}
		});
		...
		lblTitulo.setBounds(160, 42, 126, 14);
		...
		rdbtnFacil.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// TO DO: Mudar dificiuldade para fácil
			}
		});
		...
		rdbtnNormal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// TO DO: Mudar dificiuldade para normal
			}
		});
